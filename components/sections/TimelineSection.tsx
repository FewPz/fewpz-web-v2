...
const educationData: EducationItem[] = [
  {
    ...
    period: '2025 - Present',
    description: 'Honors Program student conducting research at the School of Information Technology.',
    status: 'current',
  },
  {
    logo: '/logos/kmitl.png',
    ...
    period: '2022 - 2026',
    description: 'Graduated from the Information Technology program at the School of Information Technology.',
    status: 'completed',
  },
  {
    logo: '/logos/mvsk.jpg',
    institution: 'Mahavajiravudh Changwat Songkhla School',
    degree: 'High School (Language Arts Korean-Japanese Program)',
    period: '2019 - 2022',
...
const experienceData: ExperienceItem[] = [
  {
    year: '2025',
    title: 'μJudge - Online Testing & Assessment Platform',
    description: 'Developed a faculty-funded quiz and assessment platform. Used by 100+ students and lecturers for online examinations and quizzes.',
  ...
  {
    year: '2024',
    title: 'iJudge - Online Code Judging System',
      ...
      <div className="flex gap-6 p-6 rounded-2xl bg-card border border-border hover:border-foreground/20 transition-all duration-300">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-4 mb-2">
            <div>
              <h3 className="text-lg font-medium text-foreground leading-tight">{item.institution}</h3>
